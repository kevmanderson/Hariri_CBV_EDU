...
# Only include self-reported white/non-HL subjects
pheno.data.sort <- pheno.data.sort[pheno.data.sort$Race == 'WHT',]
pheno.data.sort <- pheno.data.sort[pheno.data.sort$Ethn == 'NOT_HL',]
# ---------------------
# ---------------------
...
summary(lm(scale(EstIQ_Ship) ~ scale(IntraCranialVol) + MF + scale(Age_A) + Scanner + Console + Coil, data = pheno.data.ship.gspAnat))
...
summary(lm(scale(EstIQ_Ship) ~ scale(pT_1) + MF + scale(Age_A) + Scanner + Console + Coil + 
             eigen_resid_1 + eigen_resid_2 + eigen_resid_3 + eigen_resid_4 + eigen_resid_5 + 
             eigen_resid_6 + eigen_resid_7 + eigen_resid_8 + eigen_resid_9 + eigen_resid_10, data = pheno.data.ship.gspAnat))
...
summary(lm(scale(EstIQ_Ship) ~  scale(BrainSegNotVent) + scale(pT_1.1) + 
             ...
             eigen_resid_6 + eigen_resid_7 + eigen_resid_8 + eigen_resid_9 + eigen_resid_10, data = pheno.data.ship.gspAnat))
# intracranial volume comparison
summary(lm(scale(EstIQ_Ship) ~  scale(IntraCranialVol) + scale(pT_1.1) + 
             MF + scale(Age_A) + Scanner + Console + Coil +
             eigen_resid_1 + eigen_resid_2 + eigen_resid_3 + eigen_resid_4 + eigen_resid_5 + 
             eigen_resid_6 + eigen_resid_7 + eigen_resid_8 + eigen_resid_9 + eigen_resid_10, data = pheno.data.ship.gspAnat))
...
summary(lm(scale(BrainSegNotVent) ~ scale(pT_1.1) + 
             ...
             eigen_resid_6 + eigen_resid_7 + eigen_resid_8 + eigen_resid_9 + eigen_resid_10, data = pheno.data.ship.gspAnat))
# intracranial volume comparison
summary(lm(scale(IntraCranialVol) ~ scale(pT_1.1) + 
             MF + scale(Age_A) + Scanner + Console + Coil +
             eigen_resid_1 + eigen_resid_2 + eigen_resid_3 + eigen_resid_4 + eigen_resid_5 + 
             eigen_resid_6 + eigen_resid_7 + eigen_resid_8 + eigen_resid_9 + eigen_resid_10, data = pheno.data.ship.gspAnat))
